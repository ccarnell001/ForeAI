  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 24px', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <style>{`
        ...
        @keyframes foreai-ball { 0%{offset-distance:0%} 88%{offset-distance:100%} 100%{offset-distance:100%} }
        @keyframes foreai-trace {
          0%{stroke-dashoffset:320;opacity:0.65} 88%{stroke-dashoffset:0;opacity:0.65}
          95%{stroke-dashoffset:0;opacity:0.15} 100%{stroke-dashoffset:0;opacity:0}
        }
        @keyframes foreai-ripple {
          0%,87%{opacity:0;rx:8;ry:4} 92%{opacity:0.9;rx:8;ry:4}
          98%{opacity:0.2;rx:22;ry:10} 100%{opacity:0}
        }
        .foreai-ball-el {
      ...
      <div style={{ background: '#0a1a0a', borderRadius: 20, padding: '32px 24px', textAlign: 'center', width: '100%', maxWidth: 320 }}>
        <svg width="260" height="130" viewBox="0 0 280 134" style={{ display: 'block', margin: '0 auto 20px', width: '100%' }}>
          ...
          <circle className="foreai-ball-el" fill="#f5f5f0" stroke="#ccc" strokeWidth="0.5">
            <animate attributeName="r" values="7.5;7.5;7.5;7.5;7.5;3;0" keyTimes="0;0.3;0.6;0.75;0.87;0.93;1" dur="3.8s" repeatCount="indefinite"/>
            <animate attributeName="opacity" values="1;1;1;1;1;0.6;0" keyTimes="0;0.3;0.6;0.75;0.87;0.93;1" dur="3.8s" repeatCount="indefinite"/>
          </circle>
        ...
        {hasBothAngles && (
          <div style={{ fontSize: 11, color: '#4ade80', background: 'rgba(74,222,128,0.1)', border: '1px solid rgba(74,222,128,0.2)', borderRadius: 20, padding: '3px 12px', display: 'inline-block', marginBottom: 8 }}>
            🎯 Dual-angle analysis
          </div>
        )}
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{
                ...
                border: step.active || step.done ? 'none' : '1.5px solid #374237',
